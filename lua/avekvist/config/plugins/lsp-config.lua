...
lsp.on_attach(function(client, bufnr)
	...
	vim.keymap.set("n", "<leader>lvca", function() vim.lsp.buf.code_action() end, opts)
	vim.keymap.set("n", "<leader>lvrr", function() vim.lsp.buf.references() end, opts)
	vim.keymap.set("n", "<leader>lvrn", function() vim.lsp.buf.rename() end, opts)
